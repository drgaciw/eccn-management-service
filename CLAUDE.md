...
This project is indexed by GitNexus as **eccn-management-service** (2003 symbols, 3843 relationships, 168 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
