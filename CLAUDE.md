...
This project is indexed by GitNexus as **eccn-management-service** (1994 symbols, 3826 relationships, 167 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
